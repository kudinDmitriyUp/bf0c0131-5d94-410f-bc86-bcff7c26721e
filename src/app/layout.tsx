...
export const metadata: Metadata = {
  ...
  description: "Discover luxury properties and find your perfect home with PropertyHub. Expert real estate agents, premium listings, and personalized service.",
  keywords: "real estate, properties, homes for sale, luxury homes, real estate agent",
  openGraph: {
    title: "PropertyHub - Premium Real Estate",
    description: "Discover luxury properties and find your perfect home with PropertyHub",
